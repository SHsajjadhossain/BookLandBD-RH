                ...
                <section id="dashboard-ecommerce">
                    <div class="row match-height">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <div class="card card-congratulations welcome-card">
                                <div class="card-body text-center">
                                    <img src="{{ asset('dashboard_assets') }}/app-assets/images/elements/decore-left.png" class="congratulations-img-left"
                                        alt="card-img-left" />
                                    <img src="{{ asset('dashboard_assets') }}/app-assets/images/elements/decore-right.png" class="congratulations-img-right"
                                        alt="card-img-right" />
