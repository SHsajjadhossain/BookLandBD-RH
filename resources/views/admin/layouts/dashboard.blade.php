            ...
            <ul class="ml-auto nav navbar-nav align-items-center">
                ...
                <li class="nav-item dropdown dropdown-cart mr-25"><a class="nav-link" href="javascript:void(0);"
                    ...
                    <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
                        ...
                        <li class="scrollable-container media-list">
                            <div class="media align-items-center"><img class="mr-1 rounded d-block"
                                    src="{{ asset('dashboard_assets') }}/app-assets/images/pages/eCommerce/1.png" alt="donuts" width="62">
                            ...
                            <div class="media align-items-center"><img class="mr-1 rounded d-block"
                                    src="{{ asset('dashboard_assets') }}/app-assets/images/pages/eCommerce/7.png" alt="donuts" width="62">
                                <div class="media-body"><i class="ficon cart-item-remove" data-feather="x"></i>
                                    <div class="media-heading">
                                        <h6 class="cart-item-title"><a class="text-body"
                            ...
                            <div class="media align-items-center"><img class="mr-1 rounded d-block"
                                    src="{{ asset('dashboard_assets') }}/app-assets/images/pages/eCommerce/2.png" alt="donuts" width="62">
                                <div class="media-body"><i class="ficon cart-item-remove" data-feather="x"></i>
                                    <div class="media-heading">
                                        <h6 class="cart-item-title"><a class="text-body"
                            ...
                            <div class="media align-items-center"><img class="mr-1 rounded d-block"
                                    src="{{ asset('dashboard_assets') }}/app-assets/images/pages/eCommerce/3.png" alt="donuts" width="62">
                                <div class="media-body"><i class="ficon cart-item-remove" data-feather="x"></i>
                                    <div class="media-heading">
                                        <h6 class="cart-item-title"><a class="text-body"
                            ...
                            <div class="media align-items-center"><img class="mr-1 rounded d-block"
                                    src="{{ asset('dashboard_assets') }}/app-assets/images/pages/eCommerce/5.png" alt="donuts" width="62">
                                <div class="media-body"><i class="ficon cart-item-remove" data-feather="x"></i>
                                    <div class="media-heading">
                                        <h6 class="cart-item-title"><a class="text-body"
                ...
                <li class="nav-item dropdown dropdown-user"><a class="nav-link dropdown-toggle dropdown-user-link"
                        ...
                        <div class="user-nav d-sm-flex d-none"><span class="user-name font-weight-bolder">John
                                ...
                                class="round" src="{{ asset('dashboard_assets') }}/app-assets/images/portrait/small/avatar-s-11.jpg"
        ...
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                <li class=" nav-item"><a class="d-flex align-items-center" href="index.html"><i
                            ...
                            class="ml-auto mr-1 badge badge-light-warning badge-pill">2</span></a>
                ...
                <li class=" nav-item">
                    <a class="d-flex align-items-center" href="{{ route('frontend.home') }}">
                        ...
                        <span class="menu-title text-truncate" data-i18n="web">Visit Website</span></a>
                </li>
                ...
                <li class=" nav-item"><a class="d-flex align-items-center" href="#"><i
                            ...
                            class="ml-auto mr-2 badge badge-light-danger badge-pill">2</span></a>
                    <ul class="menu-content">
                        ...
                        <div class="col-xl-4 col-md-6 col-12">
                            <div class="card card-congratulation-medal">
                                <div class="card-body">
                                    ...
                                    <img src="{{ asset('dashboard_assets') }}/app-assets/images/illustration/badge.svg"
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="rounded avatar">
                                                                <div class="avatar-content">
                                                                    <img src="{{ asset('dashboard_assets') }}/app-assets/images/icons/toolbox.svg"
                                                                        alt="Toolbar svg" />
                                                                </div>
                                                            </div>
                                                            <div>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="rounded avatar">
                                                                <div class="avatar-content">
                                                                    <img src="{{ asset('dashboard_assets') }}/app-assets/images/icons/parachute.svg"
                                                                        alt="Parachute svg" />
                                                                </div>
                                                            </div>
                                                            <div>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="rounded avatar">
                                                                <div class="avatar-content">
                                                                    <img src="{{ asset('dashboard_assets') }}/app-assets/images/icons/brush.svg"
                                                                        alt="Brush svg" />
                                                                </div>
                                                            </div>
                                                            <div>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="rounded avatar">
                                                                <div class="avatar-content">
                                                                    <img src="{{ asset('dashboard_assets') }}/app-assets/images/icons/star.svg"
                                                                        alt="Star svg" />
                                                                </div>
                                                            </div>
                                                            <div>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="rounded avatar">
                                                                <div class="avatar-content">
                                                                    <img src="{{ asset('dashboard_assets') }}/app-assets/images/icons/book.svg"
                                                                        alt="Book svg" />
                                                                </div>
                                                            </div>
                                                            <div>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="rounded avatar">
                                                                <div class="avatar-content">
                                                                    <img src="{{ asset('dashboard_assets') }}/app-assets/images/icons/rocket.svg"
                                                                        alt="Rocket svg" />
                                                                </div>
                                                            </div>
                                                            <div>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="rounded avatar">
                                                                <div class="avatar-content">
                                                                    <img src="{{ asset('dashboard_assets') }}/app-assets/images/icons/speaker.svg"
                                                                        alt="Speaker svg" />
                                                                </div>
                                                            </div>
                                                            <div>
                        ...
                        <div class="col-lg-4 col-md-6 col-12">
                            <div class="card card-developer-meetup">
                                <div class="text-center meetup-img-wrapper rounded-top">
                                    <img src="{{ asset('dashboard_assets') }}/app-assets/images/illustration/email.svg" alt="Meeting Pic"
                                        height="170" />
                                </div>
                                <div class="card-body">
                                    ...
                                    <div class="avatar-group">
                                        <div data-toggle="tooltip" data-popup="tooltip-custom" data-placement="bottom"
                                            ...
                                            <img src="{{ asset('dashboard_assets') }}/app-assets/images/portrait/small/avatar-s-9.jpg"
                                                alt="Avatar" width="33" height="33" />
                                        </div>
                                        <div data-toggle="tooltip" data-popup="tooltip-custom" data-placement="bottom"
                                            data-original-title="Amy Carson" class="avatar pull-up">
                                            <img src="{{ asset('dashboard_assets') }}/app-assets/images/portrait/small/avatar-s-6.jpg"
                                                alt="Avatar" width="33" height="33" />
                                        </div>
                                        <div data-toggle="tooltip" data-popup="tooltip-custom" data-placement="bottom"
                                            data-original-title="Brandon Miles" class="avatar pull-up">
                                            <img src="{{ asset('dashboard_assets') }}/app-assets/images/portrait/small/avatar-s-8.jpg"
                                                alt="Avatar" width="33" height="33" />
                                        </div>
                                        <div data-toggle="tooltip" data-popup="tooltip-custom" data-placement="bottom"
                                            data-original-title="Daisy Weber" class="avatar pull-up">
                                            <img src="{{ asset('dashboard_assets') }}/app-assets/images/portrait/small/avatar-s-20.jpg"
                                                alt="Avatar" width="33" height="33" />
                                        </div>
                                        <div data-toggle="tooltip" data-popup="tooltip-custom" data-placement="bottom"
                            ...
                            <div class="card card-browser-states">
                                ...
                                <div class="card-body">
                                    <div class="browser-states">
                                        <div class="media">
                                            <img src="{{ asset('dashboard_assets') }}/app-assets/images/icons/google-chrome.png"
                                    ...
                                    <div class="browser-states">
                                        <div class="media">
                                            <img src="{{ asset('dashboard_assets') }}/app-assets/images/icons/mozila-firefox.png"
                                    ...
                                    <div class="browser-states">
                                        <div class="media">
                                            <img src="{{ asset('dashboard_assets') }}/app-assets/images/icons/apple-safari.png"
                                    ...
                                    <div class="browser-states">
                                        <div class="media">
                                            <img src="{{ asset('dashboard_assets') }}/app-assets/images/icons/internet-explorer.png"
                                    ...
                                    <div class="browser-states">
                                        <div class="media">
                                            <img src="{{ asset('dashboard_assets') }}/app-assets/images/icons/opera.png" class="mr-1 rounded"
