                    ...
                    <div class="card-body">
                        <form class="form form-vertical" action="{{ route('product.update', $product->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <select name="category_id" class="select2 form-control" id="product_category">
                                            ...
                                            <option {{ ($product->category_id == $product_category->id) ? 'selected' : '' }} value="{{ $product_category->id }}">{{
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        <label for="exampleFormControlTextarea2">Product Long Description<span
                                                class="text-danger">*</span></label>
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        <label for="custom-file">Product Photo<small class="text-warning"> (Dimensions:
                                                700 x 700 px)</small> <span class="text-danger">*</span></label>
                                        <div class="mb-1 mr-1">
                                            <img src="{{ asset('uploads/product_photoes') }}/{{ $product->product_photo }}" data-reset-src="" id="product_photo_upload_img"
                                                class="rounded uploadedAvatar object-fit--cover" alt="product photo"
                                                width="130" height="140">
                                        </div>
                                        <div class="custom-file">
                                            <input type="file" class="custom-file-input" id="product_photo_upload"
                                                name="product_photo" value="{{ asset('uploads/product_photoes') }}/{{ $product->product_photo }}" />
