        ...
        <div class="row">
            <div class="col-lg-9 order-lg-2">
                ...
                <div class="grid shop-product-wrap with-pagination row space-db--30 shop-border">
                    @forelse ($catwise_products as $single_product)
                            ...
                            <div class="product-card">
                                <div class="product-grid-content">
                                    <div class="product-header">
                                        ...
                                        <h3><a href="product-details.html">{{ $single_product->product_name }}</a></h3>
                                    </div>
                                    ...
                                    <div class="col-lg-5">
                                        ...
                                        <div class="product-details-slider sb-slick-slider arrow-type-two"
                                            ...
                                            <div class="single-slide">
                                                <img src="{{ asset('frontend_assets') }}/image/products/product-details-1.jpg"
                                                    alt="">
                                            </div>
                                            <div class="single-slide">
                                                <img src="{{ asset('frontend_assets') }}/image/products/product-details-2.jpg"
                                                    alt="">
                                            </div>
                                            <div class="single-slide">
                                                <img src="{{ asset('frontend_assets') }}/image/products/product-details-3.jpg"
                                                    alt="">
                                            </div>
                                            <div class="single-slide">
                                                <img src="{{ asset('frontend_assets') }}/image/products/product-details-4.jpg"
                                                    alt="">
                                            </div>
                                            <div class="single-slide">
                                                <img src="{{ asset('frontend_assets') }}/image/products/product-details-5.jpg"
                                                    alt="">
                                            </div>
                                        </div>
