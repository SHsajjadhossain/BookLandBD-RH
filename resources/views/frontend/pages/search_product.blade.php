...
<main class="inner-page-sec-padding-bottom">
    <div class="container">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-xl-5 col-md-4 col-sm-6 mt--10 mt-sm--0">
                    <span class="toolbar-status">
                        {{ $search_products->links('frontend.pages.paginateNumberOfPagesShowing') }}
                    </span>
                </div>
        ...
        <div class="grid shop-product-wrap with-pagination row space-db--30 shop-border">
            @forelse ($search_products as $single_product)
                ...
                <div class="product-card">
                    <div class="product-grid-content">
                        <div class="product-header">
                            ...
                            <h3><a href="{{ route('product.productDetails', $single_product->product_slug) }}">{{
                                    $single_product->product_name }}</a></h3>
                        </div>
                    ...
                    <div class="product-list-content">
                        ...
                        <div class="product-card--body">
                            <div class="product-header">
                                ...
                                <h3><a href="{{ route('product.productDetails', $single_product->product_slug) }}"
                                        tabindex="0">{{ $single_product->product_name }}</a></h3>
                            </div>
                            <article>
            ...
            <!-- Modal -->
            <div class="modal fade modal-quick-view" id="quickModal{{ $single_product->id }}" tabindex="-1"
                                ...
                                <div class="col-lg-7 mt--30 mt-lg--30">
                                    <div class="product-details-info pl-lg--30 ">
                                        ...
                                        <ul class="list-unstyled">
                                            ...
                                            <li>Product Code: <span class="list-value"> {{ $single_product->product_code
                                                    }}</span>
                                            </li>
        ...
        <div class="row pt--30">
            <div class="col-md-12">
                <div class="pagination-block">
                    {{--........................ --}}
                    {{ $search_products->links('frontend.pages.paginate') }}
                    {{--........................ --}}
                </div>
            </div>
        </div>
