                                    ...
                                    <div class="checkout-cart-total">
                                        ...
                                        <ul>
                                            @forelse (allCarts() as $cart)
                                                <li>
                                                    <span class="left">{{ $cart->relationWithProduct->product_name }}  <strong> X </strong> {{ $cart->quantity }}</span> <span
                                                        class="right">৳ {{ $cart->quantity * $cart->relationWithProduct->product_price }}</span>
                                                </li>
                                            @empty
                                                <li>
                                                    <span class="left">N/A</span> <span
                                                        class="right">৳ 00.00</span>
                                                </li>
                                            @endforelse
                                        ...
                                        <p>Cart Total <span>৳ {{ Session::get('s_cart_total') }}</span></p>
                                        <p>Discount Total <span>৳ {{ Session::get('s_discount_total') ?? '00.00' }}</span></p>
                                        <p>Sub Total (approx.) <span>৳ {{ round(Session::get('s_cart_total') - Session::get('s_discount_total')) }}</span></p>
                                        <p>Shipping Fee <span>৳ 00.00</span></p>
                                        <h4>Grand Total <span>৳ {{ round(Session::get('s_cart_total')-Session::get('s_discount_total')) + 00.00 }}</span></h4>
